...
const DepositHistory = () => {
    ...
    const { data, fetchData, count } = useFetch('/deposithistory', pageNo + 1, pageSize, filters);
    ...
    const handleDelete = async (id) => {
        try {
            await axiosInstance.delete(`/deposithistory/${id}`);
                ...
                {showFilters && (
                    <Box sx={{ display: 'flex', gap: '1rem', backgroundColor: '#FFF', marginBottom: '1rem', padding: '1rem', borderRadius: '0.5rem', overflowX: 'auto' }}>
                        ...
                        <TextField
                            ...
                            onChange={(e) => setFilters({ ...filters, depositDate: e.target.value })}
                            fullWidth
