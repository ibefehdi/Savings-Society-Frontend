...
import WithdrawalFormSavingNew from '../../printablePages/WithdrawalFormSavingNew';
import { useTranslation } from 'react-i18next';
import { TextField } from '@mui/material';
import axiosInstance from '../../constants/axiosInstance';
const WithdrawalFormPageNew = () => {
    ...
    return (
        <React.Fragment>
            <Box sx={{ width: '90%', backgroundColor: '#FFF', margin: '2rem', padding: '1rem', borderRadius: '0.5rem', overflowX: 'auto', height: '100%' }}>
                ...
                <WithdrawalFormSavingNew ref={componentRef} shareholder={shareholder} />
            </Box>
...
export default WithdrawalFormPageNew