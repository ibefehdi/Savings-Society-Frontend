...
import BoardMemberRewardForm from '../../printablePages/BoardMemberRewardForm ';
import { useTranslation } from 'react-i18next';
import BackButton from '../../components/BackButton';
const BoardMemberRewardFormPage = () => {
    ...
    return (
        <React.Fragment>
            <Box sx={{ width: '90%', backgroundColor: '#FFF', margin: '2rem', padding: '1rem', borderRadius: '0.5rem', overflowX: 'auto', height: '100%' }}>
                ...
                <BoardMemberRewardForm ref={componentRef} />
            </Box>
...
export default BoardMemberRewardFormPage