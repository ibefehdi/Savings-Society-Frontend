...
import ReturnFromLeaveNotice from '../../printablePages/ReturnFromLeaveNotice';
import { useTranslation } from 'react-i18next';
const ReturnFromLeavePage = () => {
    ...
    return (
        <React.Fragment>
            <Box sx={{ width: '90%', backgroundColor: '#FFF', margin: '2rem', padding: '1rem', borderRadius: '0.5rem', overflowX: 'auto', height: '100%' }}>
                ...
                <ReturnFromLeaveNotice ref={componentRef} />
            </Box>
...
export default ReturnFromLeavePage