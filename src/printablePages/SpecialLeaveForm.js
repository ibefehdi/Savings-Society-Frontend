...
const SpecialLeaveForm = React.forwardRef((props, ref) => {
    return (
        <div ref={ref} style={{ fontFamily: 'Arial, sans-serif', width: '100%', margin: 'auto', padding: '20px', border: "1px solid black", direction: 'rtl' }}>
            ...
            <div style={{ fontFamily: 'Arial, sans-serif', fontSize: '14px', textAlign: 'right', width: '100%', margin: 'auto', padding: '5px', direction: 'rtl' }}>
                <h1 style={{ fontSize: '28px', textAlign: 'center', fontWeight: 'bolder' }}>نموذج طلب إجازة خاصة (بدون مرتب)</h1>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    <p>أرجو الموافقة على منحي إجازة خاصة بدون مرتب مـن <span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span>/<span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span>/202<span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span> حتى <span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span>/<span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span>/202<span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span></p>
                    <p>وذلك للأسباب التالية:</p>
                    <p><span style={{ borderBottom: "1px solid black", paddingRight: '100%', }}>&nbsp;</span></p>
                ...
                <div style={{ marginTop: '20px' }}>
                    <p>تاريخ آخر مرة منح فيها إجازة خاصة (بدون مرتب) <span style={{ borderBottom: "1px solid black", paddingRight: '400px', }}>&nbsp;</span></p>
                    <p>رصيد الموظف من الاجازات الدورية (<span style={{ borderBottom: "1px solid black", paddingRight: '100px', }}>&nbsp;</span>) يوم.</p>
                </div>
