    ...
    return (
        <div ref={ref} style={{ fontFamily: 'Arial, sans-serif', width: '100%', margin: 'auto', padding: '20px', border: "1px solid black", direction: 'rtl' }}>
            ...
            <div style={{ fontFamily: 'Arial, sans-serif', fontSize: '14px', textAlign: 'right', width: '100%', margin: 'auto', padding: '5px', direction: 'rtl' }}>
                ...
                {/* Main Content */}
                <p>يرجى التفضل بالموافقة على صرف مبلغ <span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span>/<span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span> د.ك ( فقط<span style={{ borderBottom: "1px solid black", paddingRight: '150px', }}>&nbsp;</span>)</p>

                <p>من رصيد مدخراتي طبقا للسجلات المحاسبية طرفكم في <span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span>/<span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span>/<span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span> م، مع تحويل صافي إرباحي</p>
                ...
                <div style={{ borderTop: '1px solid #000', paddingTop: '10px' }}>
                    ...
                    <p>رقم العضوية: <span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span> نوع الحساب: (<span style={{ borderBottom: "1px solid black", paddingRight: '100px', }}>&nbsp;</span>) تاريخ الانتساب: <span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span>/<span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span>/<span style={{ borderBottom: "1px solid black", paddingRight: '50px', }}>&nbsp;</span></p>

                    {/* Financial Details */}
                    <table style={{ width: '100%', textAlign: 'right', direction: 'rtl', marginBottom: '0' }}>
                        <thead>
                            <tr>
                                <td style={{ border: '1px solid #000', fontWeight: 'bold', padding: '2px' }}>البيان</td>
